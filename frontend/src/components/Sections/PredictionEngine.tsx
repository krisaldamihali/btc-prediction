...
import { ChevronRight, BarChart2, Globe, Zap, Cpu, Database } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-32">
          ...
          <p className="text-white/30 text-xl font-light max-w-xl">
            Surgical precision in a chaotic market. Adjust the temporal slider to recalibrate the neural core.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          <div className="lg:col-span-4">
            ...
            >
              <div className="space-y-16">
                <div>
                  <div className="flex justify-between items-center mb-10">
                    ...
                    <span className="px-3 py-1 bg-brand/10 rounded text-[9px] font-bold text-brand uppercase">Stable</span>
                  </div>
                  
                  <div className="space-y-8">
                    <div className="flex justify-between items-end">
                       <p className="text-[10px] font-black uppercase text-white/30 tracking-widest">Time_Horizon</p>
                       <p className="text-4xl font-black text-white italic">{horizon}<span className="text-sm not-italic opacity-30 ml-1">DAYS</span></p>
                    </div>
                    <input 
                      type="range" min="7" max="365" value={horizon}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/5 flex flex-col gap-4">
                    ...
                    <p className="text-[9px] font-bold uppercase tracking-widest text-white/40 leading-tight">Global_Sync: ACTIVE</p>
                  </div>
                  <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/5 flex flex-col gap-4">
                    <Database size={20} className="text-gold" />
                    <p className="text-[9px] font-bold uppercase tracking-widest text-white/40 leading-tight">Data_Node: 1,402</p>
                  </div>
                </div>
              </div>
              ...
              >
                {loading ? 'Recalibrating...' : 'Execute Sequence'}
            ...
            <AnimatePresence mode="wait">
              {!result && !loading && (
                ...
                >
                  ...
                  <p className="text-[10px] font-black tracking-[0.6em] uppercase text-white/10">Neural_Core_Idle</p>
                </motion.div>
              )}
                ...
                >
                   <div className="relative w-48 h-48">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                         <p className="text-[10px] font-black text-brand tracking-widest uppercase">Syncing</p>
                      </div>
                   </div>
                </motion.div>
              )}
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="space-y-10">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="glass-panel p-12 thin-border bg-white/[0.02] relative overflow-hidden group">
                       ...
                       <p className="text-[10px] text-white/30 uppercase tracking-[0.4em] mb-4 font-black">Epoch_Peak</p>
                    ...
                    <div className="glass-panel p-12 thin-border bg-white/[0.02] relative overflow-hidden group">
                       ...
                       <p className="text-[10px] text-white/30 uppercase tracking-[0.4em] mb-4 font-black">Confidence_Rating</p>
                       <div className="flex items-center gap-6">
                          <p className="text-7xl font-black tracking-tighter text-gold">{(result.metrics.R2 * 100).toFixed(1)}%</p>
                          <div className="px-4 py-2 rounded-xl bg-gold/10 border border-gold/20 text-[10px] font-black text-gold uppercase tracking-widest">Ultra</div>
                       </div>
                    </div>
                  </div>
